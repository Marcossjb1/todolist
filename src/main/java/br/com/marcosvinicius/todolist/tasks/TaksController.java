package br.com.marcosvinicius.todolist.tasks;

import br.com.marcosvinicius.todolist.utils.Utils;
...
public class TaksController {
    ...
    public ResponseEntity<String> create(@RequestBody TaskModel taskModel, HttpServletRequest request){
        ...
        if(currentDate.isAfter(taskModel.getCreatedAt()) || currentDate.isAfter(taskModel.getEndAt())){
